...
app.post('/read-arrangement', async function(req, res) {
  try {
    ...
    const prompt = `Extract timetable from photo period wise.

For each entry match the teacher name to the closest name from this official list:
${TEACHER_LIST.join(', ')}
...
Period mapping: column 1="I", 2="II", 3="III", 4="IV", 5="V", 6="VI", 7="VII", 8="VIII"
- teacher: must exactly match a name from the official list
- mergeClass: always null
- type: always "duty"
