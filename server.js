...
- IMPORTANT: If class is written as "XII B+A" split into TWO entries: "XII B" and "XII A" with same teacher. "X D+C" = "X D" + "X C". "IX A+B" = "IX A" + "IX B". "VIII C+B" = "VIII C" + "VIII B". "VII B+A" = "VII B" + "VII A". "VI C+B" = "VI C" + "VI B".

VALID CLASS NAMES — absentClass must be exactly one of these:
${CLASS_LIST.join(', ')}
...
[
  { "period": "I", "absentClass": "XII B", "mergeClass": null, "teacher": "YESPAL SINGH", "type": "duty" },
  { "period": "I", "absentClass": "XII A", "mergeClass": null, "teacher": "YESPAL SINGH", "type": "duty" },
  { "period": "I", "absentClass": "X D", "mergeClass": null, "teacher": "MH ASHIQEEN", "type": "duty" },
  { "period": "I", "absentClass": "X C", "mergeClass": null, "teacher": "MH ASHIQEEN", "type": "duty" },
