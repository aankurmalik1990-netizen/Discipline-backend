...
// ── Arrangement Photo OCR (Claude Vision) ──
...
Read it carefully and extract ALL arrangement entries from the table.
...
- mergeClass: the class they merge INTO (null if duty only)
- teacher: the alternate/arrangement teacher name in CAPS
...
- Return ONLY the JSON array, nothing else`;
    ...
    console.log('Claude OCR:', JSON.stringify(data).substring(0, 300));
